...
Data file: $NORU_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_NORU_HOME = Path(os.environ.get("NORU_HOME", Path.home() / ".hermes"))
DATA_DIR = _NORU_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
