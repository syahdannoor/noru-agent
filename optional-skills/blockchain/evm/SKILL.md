...
Helper script path: `~/.noru/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.noru/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.noru/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.noru/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
