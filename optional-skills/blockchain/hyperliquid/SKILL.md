...
The script reads `~/.noru/.env` for two optional defaults:
...
Helper script: `~/.noru/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.noru/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.noru/.env`.
...
```bash
python3 ~/.noru/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.noru/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
