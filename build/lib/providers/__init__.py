...
2. User plugins: ``$NORU_HOME/plugins/model-providers/<name>/``
...
def register_provider(profile: ProviderProfile) -> None:
    ...
    plugins under ``$NORU_HOME/plugins/model-providers/`` can override
...
def _user_plugins_dir() -> Path | None:
    """Return ``$NORU_HOME/plugins/model-providers/`` if it exists."""
    try:
        from noru_constants import get_noru_home

        d = get_noru_home() / "plugins" / "model-providers"
...
def _import_plugin_dir(plugin_dir: Path, source: str) -> None:
    ...
    # multiple NORU_HOME profiles don't alias each other.
...
def _discover_providers() -> None:
    ...
    Order:
      ...
      2. User plugins at ``$NORU_HOME/plugins/model-providers/<name>/``
    ...
    # 2. User plugins — under $NORU_HOME/plugins/model-providers/<name>/.
