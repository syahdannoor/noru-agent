...
Config stored in ~/.noru/config.yaml under:
...
from noru_cli.config import cfg_get, load_config, save_config
from noru_cli.colors import Colors, color
from noru_cli.platforms import PLATFORMS as _PLATFORMS
