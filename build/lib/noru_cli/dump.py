...
from noru_cli.config import get_noru_home, get_env_path, get_project_root, load_config
...
def _gateway_status() -> str:
    ...
    try:
        from noru_cli.gateway import get_gateway_runtime_snapshot
...
def run_dump(args):
    ...
    lines.append(f"hermes_home:      {display_noru_home()}")
