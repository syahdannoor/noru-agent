...
Skins are defined as YAML files in ~/.noru/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Noru Agent"          # Banner title, status display
...
.. code-block:: python
    ...
    from noru_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Noru Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.noru/skins/
...
Drop a YAML file in ``~/.noru/skins/<name>.yaml`` following the schema above.
