...
~/.noru/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.noru/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.noru/skills/) first, then any
...
def _find_skill_in_other_profiles(name: str) -> List[Tuple[str, Path]]:
    ...
    # Default profile (~/.noru/skills) — only consider when active is non-default.
    ...
    # All named profiles (~/.noru/profiles/*/skills)
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        f"New skills go to {display_noru_home()}/skills/; existing skills can be modified wherever they live.\n\n"
