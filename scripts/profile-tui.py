...
~30 Hz (matching xterm key-repeat), summarizes ~/.noru/perf.log on exit.
...
Environment overrides:
  HERMES_PERF_LOG     (default ~/.noru/perf.log)
...
DEFAULT_LOG = Path(os.environ.get("HERMES_PERF_LOG", str(get_noru_home() / "perf.log")))
DEFAULT_STATE_DB = get_noru_home() / "state.db"
