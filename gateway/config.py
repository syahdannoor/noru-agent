...
class GatewayConfig:
    ...
    # Storage paths
    sessions_dir: Path = field(default_factory=lambda: get_noru_home() / "sessions")
...
def load_gateway_config() -> GatewayConfig:
    ...
    2. ~/.noru/config.yaml (primary user-facing config)
    3. ~/.noru/gateway.json (legacy — provides defaults under config.yaml)
    4. Built-in defaults
    """
    _home = get_noru_home()
    gw_data: dict = {}
