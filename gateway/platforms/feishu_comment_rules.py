...
Config: ~/.noru/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.noru/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_noru_home()`` helper (NORU_HOME-aware and
...
RULES_FILE = get_noru_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_noru_home() / "feishu_comment_pairing.json"
