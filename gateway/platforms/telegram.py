...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                from noru_cli.commands import telegram_menu_commands
    ...
    def _build_provider_keyboard(self, providers: list):
        ...
        """
        try:
            from noru_cli.models import group_providers
        except Exception:
    ...
    async def _handle_model_picker_callback(
        ...
        if data.startswith("mp:"):
            ...
            group_id = data[4:]
            try:
                from noru_cli.models import PROVIDER_GROUPS
    ...
    # Scripts live in ~/.noru/scripts/gmail-triage/. `arg` from the callback
