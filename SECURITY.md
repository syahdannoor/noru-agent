...
Report privately via [GitHub Security Advisories](https://github.com/syahdannoor/noru-agent/security/advisories/new)
...
- **Documented break-glass settings.** Operator-selected trade-offs
  ...
  noru-home security, and similar. Reports against those
