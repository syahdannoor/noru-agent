...
Sessions are persisted to the shared SessionDB (``~/.noru/state.db``) so they
...
def _translate_acp_cwd(cwd: str) -> str:
    ...
    """
    from noru_constants import is_wsl
...
class SessionManager:
    ...
    def __init__(self, agent_factory=None, db=None):
        ...
        Args:
            ...
            db:            Optional SessionDB instance. When omitted, the default
                           SessionDB (``~/.noru/state.db``) is lazily created.
        """
    ...
    def _get_db(self):
        ...
        Note: we resolve ``NORU_HOME`` dynamically rather than relying on
