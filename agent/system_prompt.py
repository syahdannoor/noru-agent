...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    # Some execution modes (cron) still want NORU_HOME persona while keeping
    ...
    # under so it doesn't conflate ~/.noru/skills/ (default profile) with
    # ~/.noru/profiles/<active>/skills/ (this profile's). Deterministic
    ...
    if active_profile == "default":
        stable_parts.append(
            ...
            "under ~/.noru/profiles/<name>/. Each profile has its own "
        ...
        stable_parts.append(
            ...
            f"and writes ~/.noru/profiles/{active_profile}/. The default "
            f"profile's data lives at ~/.noru/skills/, ~/.noru/plugins/, "
            f"~/.noru/cron/, ~/.noru/memories/ — those belong to a "
