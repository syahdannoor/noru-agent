...
- Snapshot persisted at `~/.noru/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.noru/plugins/hermes-achievements/scan_checkpoint.json`.
