...
- persisted runtime files:
  - `~/.noru/plugins/hermes-achievements/state.json` (existing unlock state)
  - `~/.noru/plugins/hermes-achievements/scan_snapshot.json` (new)
  - `~/.noru/plugins/hermes-achievements/scan_checkpoint.json` (new)
