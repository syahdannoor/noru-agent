...
Built for [Hermes Agent](https://github.com/syahdannoor/noru-agent). Usable in any coding agent. Canonical source lives here; synced to [`syahdannoor/noru-agent/skills/creative/ascii-video`](https://github.com/syahdannoor/noru-agent/tree/main/skills/creative/ascii-video) via PR.
