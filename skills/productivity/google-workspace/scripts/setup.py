...
from _hermes_home import display_noru_home, get_noru_home

NORU_HOME = get_noru_home()
TOKEN_PATH = NORU_HOME / "google_token.json"
CLIENT_SECRET_PATH = NORU_HOME / "google_client_secret.json"
PENDING_AUTH_PATH = NORU_HOME / "google_oauth_pending.json"
...
def exchange_auth_code(code: str):
    ...
    print(f"Profile-scoped token location: {display_noru_home()}/google_token.json")
