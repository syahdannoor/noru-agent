...
- Subscriptions persist to `~/.noru/webhook_subscriptions.json`

## How It Works

1. `hermes webhook subscribe` writes to `~/.noru/webhook_subscriptions.json`
...
3. **Check gateway logs:** `grep webhook ~/.noru/logs/gateway.log | tail -20`
