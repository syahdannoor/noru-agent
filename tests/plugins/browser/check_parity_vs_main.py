...
Run from the PR worktree:
    ...
    cd ~/.noru/hermes-agent/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.noru/hermes-agent``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.noru/hermes-agent
...
# Isolated NORU_HOME for the config write.
