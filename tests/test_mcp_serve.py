...
def _isolate_hermes_home(tmp_path, monkeypatch):
    """Redirect NORU_HOME to a temp directory."""
    monkeypatch.setenv("NORU_HOME", str(tmp_path))
    try:
        import noru_constants
        monkeypatch.setattr(noru_constants, "get_noru_home", lambda: tmp_path)
...
def _create_test_db(db_path, session_id, messages):
    """Create a minimal SQLite DB mimicking noru_state schema."""
