"""Tests for the kanban CLI surface (noru_cli.kanban)."""
...
from noru_cli import kanban as kc
...
def test_kanban_in_autocomplete_table():
    from noru_cli.commands import COMMANDS, SUBCOMMANDS
...
def test_kanban_not_gateway_only():
    ...
    from noru_cli.commands import COMMAND_REGISTRY
