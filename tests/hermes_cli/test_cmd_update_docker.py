...
from noru_cli.main import _cmd_update_check, cmd_update


# ---------- cmd_update (apply path) ----------


@patch("noru_cli.config.is_managed", return_value=False)
@patch("noru_cli.config.detect_install_method", return_value="docker")
...
def test_format_docker_update_message_contents():
    ...
    assert "NORU_HOME" in msg or "/opt/data" in msg, (
