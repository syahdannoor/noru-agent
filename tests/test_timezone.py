"""
Tests for timezone support (noru_time module + integration points).
...
def _reset_noru_time_cache():
    """Reset the noru_time module cache (replacement for removed reset_cache)."""
    noru_time._cached_tz = None
    noru_time._cached_tz_name = None
    noru_time._cache_resolved = False


# =========================================================================
# noru_time.now() — core helper
# =========================================================================
...
class TestHermesTimeNow:
    ...
    def test_invalid_timezone_falls_back(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="noru_time"):
            result = noru_time.now()
