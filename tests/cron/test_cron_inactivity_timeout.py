...
class TestSysPathOrdering:
    ...
    def test_noru_time_importable(self):
        """noru_time should be importable when cron.scheduler loads."""
    ...
    def test_noru_constants_importable(self):
        """noru_constants should be importable from cron context."""
        from noru_constants import get_noru_home
        assert callable(get_noru_home)
