...
def store(tmp_path, monkeypatch):
    ...
    ~/.noru/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at noru_state import time, before pytest's NORU_HOME monkeypatch
    fires — the autouse fixture's NORU_HOME override doesn't help here.)
    """
    import noru_state
