"""Tests for noru_constants module."""
...
class TestGetDefaultHermesRoot:
    ...
    def test_no_hermes_home_returns_native(self, tmp_path, monkeypatch):
        """When NORU_HOME is not set, returns ~/.hermes."""
    ...
    def test_hermes_home_is_native(self, tmp_path, monkeypatch):
        """When NORU_HOME = ~/.hermes, returns ~/.hermes."""
        native = tmp_path / ".hermes"
        native.mkdir()
        monkeypatch.setattr(Path, "home", lambda: tmp_path)
        monkeypatch.setenv("NORU_HOME", str(native))
        assert get_default_hermes_root() == native

    def test_hermes_home_is_profile(self, tmp_path, monkeypatch):
        """When NORU_HOME is a profile under ~/.hermes, returns ~/.hermes."""
        native = tmp_path / ".hermes"
    ...
    def test_hermes_home_is_docker(self, tmp_path, monkeypatch):
        """When NORU_HOME points outside ~/.hermes (Docker), returns NORU_HOME."""
    ...
    def test_hermes_home_is_custom_path(self, tmp_path, monkeypatch):
        """Any NORU_HOME outside ~/.hermes is treated as the root."""
    ...
    def test_docker_profile_active(self, tmp_path, monkeypatch):
        """When a Docker profile is active (NORU_HOME=<root>/profiles/<name>),
...
class TestIsContainer:
    ...
    def _reset_cache(self, monkeypatch):
        ...
        monkeypatch.setattr(noru_constants, "_container_detected", None)
    ...
    def test_caches_result(self, monkeypatch):
        ...
        monkeypatch.setattr(noru_constants, "_container_detected", True)
        assert is_container() is True
