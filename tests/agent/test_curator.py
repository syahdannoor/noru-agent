...
def curator_env(tmp_path, monkeypatch):
    """Isolated NORU_HOME + freshly reloaded curator + skill_usage modules."""
...
def test_cli_unpin_refuses_bundled_skill(curator_env, capsys):
    ...
    from noru_cli import curator as cli
    skills_dir = curator_env["home"] / "skills"
...
def test_curator_slot_is_canonical_aux_task():
    ...
    from noru_cli.main import _AUX_TASKS
    from noru_cli.web_server import _AUX_TASK_SLOTS
