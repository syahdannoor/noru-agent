...
export const ru: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Удалить этот плагин из ~/.noru/plugins/?",
    removeHint: "Удалять можно только плагины, установленные пользователем в ~/.noru/plugins.",
  ...
  skills: {
    ...
    filters: "Фильтры",
    noSkills: "Навыки не найдены. Навыки загружаются из ~/.noru/skills/",
