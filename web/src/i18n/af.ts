...
export const af: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.noru/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.noru/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.noru/skills/",
