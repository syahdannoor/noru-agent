...
export const en: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Remove this plugin from ~/.noru/plugins/?",
    removeHint: "Only user-installed plugins under ~/.noru/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.noru/skills/",
