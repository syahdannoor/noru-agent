...
export const hu: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.noru/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.noru/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.noru/skills/ mappából töltődnek be",
