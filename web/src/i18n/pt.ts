...
export const pt: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Remover este plugin de ~/.noru/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.noru/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.noru/skills/",
