...
export const uk: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Видалити цей плагін з ~/.noru/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.noru/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.noru/skills/",
