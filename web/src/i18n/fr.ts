...
export const fr: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Retirer ce plugin de ~/.noru/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.noru/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.noru/skills/",
