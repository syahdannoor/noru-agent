...
export const tr: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Bu eklenti ~/.noru/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.noru/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.noru/skills/ adresinden yüklenir",
