...
export const de: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Dieses Plugin aus ~/.noru/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.noru/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.noru/skills/ geladen",
