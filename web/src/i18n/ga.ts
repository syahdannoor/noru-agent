...
export const ga: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Bain an plugin seo ó ~/.noru/plugins/?",
    removeHint: "Ní féidir ach plugins atá suiteáilte ag an úsáideoir faoi ~/.noru/plugins a bhaint.",
  ...
  skills: {
    ...
    filters: "Scagairí",
    noSkills: "Níor aimsíodh scileanna. Luchtaítear scileanna ó ~/.noru/skills/",
