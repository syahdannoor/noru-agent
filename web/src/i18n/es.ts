...
export const es: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.noru/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.noru/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.noru/skills/",
